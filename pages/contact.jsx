...
import { NAME, DETAILS, CONTACTS, DESIGNATION, SOCIAL_LINKS } from '../constants/constants';
        ...
        <BannerLayout>
            <div className=" px-4 py-2">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-5 text-xs">
                        <div className="card_stylings w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray md:text-sm'>Migranium</span>
                            </div>
                        </div>
                        <div className="card_stylings rounded-xl w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray text-sm'>temitopebankole</span>
                            </div>
                            <div className="flex justify-between items-center">
                ...
                <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
                    ...
                    <a className='hover:scale-125 ease-in-out duration-700 hidden sm:block' href={SOCIAL_LINKS.MEDIUM} target='_blank' rel="noreferrer"><FaMedium /></a>
            ...
            >
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <a className='underline text-Snow' target='_blank' href={SOCIAL_LINKS.GITHUB + 'temitopebankole'}>Be the one to integrate this!</a>
                </div>
            </Modal>
            <Footer />
        </BannerLayout>
